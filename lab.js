...
// Do not edit the code below.
var myFavoriteNumbers = [4,8,12,16,20,24,100];
// Do not edit the code above.
...
////////// PROBLEM 13 //////////
// Switch statements can be excellent alternatives to for loops. 
...
/* The famous FizzBuzz, Devmountain style!
  ...
  if the number your for loop is currently on is divisible by 3, console.log 'Dev'. If the number is divisible by 5, console.log 'mountain'. 
